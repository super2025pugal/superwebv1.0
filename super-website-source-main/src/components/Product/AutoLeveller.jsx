    ...
    <div>
      ...
      <section>
        <div className="banner_sec_bx">
          <h5 className="main_text">Our Product</h5>
        </div>
      </section>
                  ...
                  <Slider {...settings}>
                    <div>
                      ...
                      >
                        <img
                          className="img-fluid"
                          src="../images/products/super-d1.webp"
                          alt="spares"
                        />
                      </a>
                    </div>
                    <div>
                      ...
                      >
                        <img
                          className="img-fluid"
                          src="../images/products/super-d2.webp"
                          alt="spares"
                        />
                      </a>
                    </div>
      ...
      <section className="product__layout__section">
        ...
        <div className="product__layout">
          <img
            className="img-fluid"
            src="https://supergroupscbe.com/wp-content/uploads/2016/07/autoleveler-layout.png"
          />
        </div>
      </section>
    </div>
