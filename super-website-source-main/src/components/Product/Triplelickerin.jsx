...
const Triplelickerin = () => {
  ...
  const images = [
   ...
   "../images/manufacture/w4.png",
    "../images/manufacture/web2.png",
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
      ...
      >
        <button
          onClick={() => navigate("/products/supercard-sc1")}
          style={{
            padding: "10px 20px",
    ...
    backgroundColor: "#f9fafb",
          ...
          <div>
            ...
            >
              Triple Licker-in Configuration
            </p>
            ...
            >
              ...
              production rates. The triple licker-in system provides superior
              pre-opening and trash extraction.
            </p>
      ...
      >
        ...
        <p style={{ marginBottom: "24px" }}>
          Contact our team to learn more about Super Card SC1 Triple Licker-in.
        </p>
        <a href="/contact">
          <button
            style={{
