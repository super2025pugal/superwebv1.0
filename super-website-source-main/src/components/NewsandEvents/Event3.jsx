...
const Event3 = () => {
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event3">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>CONFERANCE AT BANGLADESH</h1>
            ...
            <p style={styles.subtitle}>
              Conference at Bangladesh – Feb 2024 Gallery
            </p>
          </header>
              ...
              return (
                ...
                >
                  <div style={styles.imageWrap}>
                    <img
                      src={item.img}
                      alt={`Conference at Bangladesh Feb 2024 ${item.id}`}
                      style={{
                        ...styles.img,
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`Conference at Bangladesh Feb 2024 ${images[currentIndex].id}`}
