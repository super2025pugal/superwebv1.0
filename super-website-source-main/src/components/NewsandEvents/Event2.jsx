...
const Event2 = () => {
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event2">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>TEXFAIR 2024</h1>
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`TEXFAIR 2024 ${images[currentIndex].id}`}
