...
const Career = () => {
  ...
  const jobs = [
    ...
    },
    {
      ...
      description: "Provide technical support and maintenance services for textile machinery installations.",
      requirements: [
        "Bachelor's degree in Mechanical/Electrical Engineering",
        "5-7 years of experience in service engineering",
    ...
    
    {
    ...
    },
     {
      ...
      requirements: ["Bachelor's degree", "Strong sales and marketing skills", "Willingness to travel", "Textile knowledge of machinery preferred"],
    },
  ];
