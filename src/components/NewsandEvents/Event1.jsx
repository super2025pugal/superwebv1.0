...
const Event1 = () => {
  const images = [
    { id: 1, img: "/images/news1.png" },
    { id: 2, img: "/images/singapore/s1.webp" },
    { id: 3, img: "/images/singapore/s2.webp" },
    { id: 4, img: "/images/singapore/s3.webp" },
    { id: 5, img: "/images/singapore/s4.webp" },
    { id: 6, img: "/images/singapore/s5.webp" },
    { id: 7, img: "/images/singapore/s7.webp" },
    { id: 8, img: "/images/singapore/s8.webp" },
    { id: 9, img: "/images/singapore/s9.webp" },
    { id: 10, img: "/images/singapore/s10.webp" },
    { id: 11, img: "/images/singapore/s11.webp" },
    { id: 12, img: "/images/singapore/s12.webp" },
    { id: 13, img: "/images/singapore/s13.webp" },
    { id: 14, img: "/images/singapore/s14.webp" },
    { id: 15, img: "/images/singapore/s15.webp" },
  ];
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event1">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>SINGAPORE EVENT</h1>
            ...
            <p style={styles.subtitle}>
              ITMA ASIA + CITME 2025 – Singapore Gallery
            </p>
          </header>
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`Singapore Event ${images[currentIndex].id}`}
