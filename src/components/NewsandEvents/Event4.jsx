...
const Event4 = () => {
  const images = [
    { id: 1, img: "/images/news4.png" },
    { id: 2, img: "/images/Texfair22/tex1.png" },
    { id: 3, img: "/images/Texfair22/tex2.png" },
    { id: 4, img: "/images/Texfair22/tex3.png" },
    { id: 5, img: "/images/Texfair22/tex4.png" },
    { id: 6, img: "/images/Texfair22/tex5.png" },
    { id: 7, img: "/images/Texfair22/tex6.png" },
  ];
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event4">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>TEXFAIR 2022</h1>
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`TEXFAIR 2022 ${images[currentIndex].id}`}
