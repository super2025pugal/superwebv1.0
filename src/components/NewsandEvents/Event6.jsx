...
const Event6 = () => {
  const images = [
    { id: 1, img: "/images/news6.png" },
    { id: 2, img: "/images/noida/n1.webp" },
    { id: 3, img: "/images/noida/n2.webp" },
    { id: 4, img: "/images/noida/n3.webp" },
  ];
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event6">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>ITME NOIDA</h1>
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`ITME Noida ${images[currentIndex].id}`}
