...
const FoundersDay = () => {
  const images = [
    { id: 1, img: "/images/f0.webp" },
    { id: 2, img: "/images/foundersday/f1.webp" },
    { id: 3, img: "/images/foundersday/f2.webp" },
    { id: 4, img: "/images/foundersday/f3.webp" },
    { id: 5, img: "/images/foundersday/f4.webp" },
    { id: 6, img: "/images/foundersday/f5.webp" },
  ];
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Foundersday">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>FOUNDER'S DAY CELEBRATION</h1>
            ...
            <p style={styles.subtitle}>
              Celebrating our journey, honoring our roots, and looking forward to excellence
            </p>
          </header>
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`Founder's Day ${images[currentIndex].id}`}
