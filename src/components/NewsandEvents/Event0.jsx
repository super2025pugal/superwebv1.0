...
const Event0 = () => {
  const images = [
    { id: 1, img: "/images/news01.webp" },
    { id: 2, img: "/images/texfair2026/t1.webp" },
    { id: 3, img: "/images/texfair2026/t2.webp" },
    { id: 4, img: "/images/texfair2026/t3.webp" },
    { id: 5, img: "/images/texfair2026/t4.webp" },
  ...
  return (
    <EventPageTemplate currentPath="/NewsandEvents/Event0">
      <style>
        {`
          @keyframes fadeIn {
            from { opacity: 0; }
        ...
        <div style={styles.container}>
          <header style={styles.header}>
            <div style={styles.titleWrapper}>
              <h1 style={styles.title}>TEXFAIR 2026</h1>
              ...
              return (
                ...
                >
                  <div style={styles.imageWrap}>
                    <img
                      src={item.img}
                      alt={`TEXFAIR 2026 - Image ${item.id}`}
                      style={{
                        ...styles.img,
        ...
        >
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              ...
              alt={`TEXFAIR 2026 - Image ${images[currentIndex].id}`}
